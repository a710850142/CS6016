...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        string CreateNewUser(string firstName, string lastName, DateTime DOB, string departmentAbbrev, string role)
        {
            ...
            do
            {
                // Create a uID with 'u' followed by 7 random digits
            ...
            // Convert DateTime to DateOnly for database compatibility
            DateOnly dateOnlyDOB = DateOnly.FromDateTime(DOB);
            ...
            switch (role)
            {
                ...
                case "Administrator":
                    ...
                    break;
                default:
                    // Throw an exception if an invalid role is specified
